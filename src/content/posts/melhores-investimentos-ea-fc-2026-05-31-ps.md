...
faq:
  - q: "Qual a melhor carta para investir hoje (31/05/2026) no EA FC?"
    a: "Juan Mata (88, A-League) lidera, com +58.6% em 7 dias a 56k coins no Console (PS), e o modelo dá 27% de chance de seguir subindo."
...
> 🔝 **Destaque:** Juan Mata (88) acumula **+58.6% em 7 dias** a 56k coins.
...
- **Unai López (87)** — 15k coins, **+15.4% em 7 dias** (+5.3% em 24h). Preço +19% acima da média de 7 dias (aquecida). Momentum positivo; acompanhe para escolher o ponto de entrada.

- **Pedri (90)** — 180k coins, **+9.1% em 7 dias** (+28.6% em 24h). Preço +13% acima da média de 7 dias (aquecida). ⚠️ Porém o modelo já vê risco de correção no curtíssimo prazo — entre com cautela.

- **Andrea Medina (86)** — 25k coins, **+7.5% em 7 dias** (+1% em 24h). Preço em linha com a média de 7 dias (+1%). Momentum positivo; acompanhe para escolher o ponto de entrada.
...
Juan Mata (88, A-League) lidera, com +58.6% em 7 dias a 56k coins no Console (PS), e o modelo dá 27% de chance de seguir subindo.
